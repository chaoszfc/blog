...
<div class="w-all w-minw bd-sd-b hg-45">
    <div class="w-main m-auto"> 
        ...
        <div class="fr"> 
            <!--登录注册 start-->
            <div class="fl">
                <a class="fs-12 ftc-000000 line-h45" href="#">
                    <i class="p-l-20 ql_icon login_icon hg-45 fl m-r-10"></i>
                       请登录
                </a>
                <span class="fs-12 ftc-000000 line-h45 m-l-15 m-r-15">|</span>
                <a class="fs-12 ftc-000000 line-h45" href="#">注册</a>
            </div>
            <!--登录注册 end-->
            <!--top 客服中心 start-->
...
<div class="w-all w-minw bg-c-fcfcfc ovhidden">
    <div class="w-main m-auto"> 
        ...
        <div class="w-1150 p-l-25 p-r-25 bg-c-ffffff fl">
            ...
            <div class="w-1150 ql_ftclass">
                ...
                {{--<div class="w-all p-t-16 p-b-16 ovhidden">--}}
                    {{--<div class="w-80 fs-14 line-h28 m-t-6 m-b-6 ftc-888888 fl">硬件</div>--}}
                    {{--<ul class="w-970 fl">--}}
                ...
                {{--<div class="w-all p-t-16 p-b-16 ovhidden">--}}
                    ...
                    {{--<ul class="w-970 fl">--}}
                        {{--<li class="w-70 m-l-24 fl"><a href="#" class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl class_cur">不限</a></li>--}}
                        {{--<li class="w-70 m-l-24 fl"><a href="#" class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl">价格亲民</a></li>--}}
        ...
        <div class="w-1170 bg-c-ffffff p-t-10 p-b-10 p-r-15 p-l-15 fl m-t-30">
            <dl class="ql_sort">
                <dd class="w-60 p-l-10 curpter fs-14 ftc-000000 line-h24 m-l-12 fl">排序</dd>
                <dd class="w-60 p-l-10 curpter fs-14 ftc-000000 line-h24 m-l-12 fl
                <?php if(isset($_GET['id'])&&$_GET['id']==1){echo "cur";} ?>">
                    <a href = '/hardware?id=1'>人气</a></dd>
                <dd class="w-60 p-l-10 curpter fs-14 ftc-000000 line-h24 m-l-12 fl
                <?php if(isset($_GET['id'])&&$_GET['id']==2){echo "cur";} ?>">
                    <a href = '/hardware?id=2'>时间</a></dd>
                <dd class="w-60 p-l-10 curpter fs-14 ftc-000000 line-h24 m-l-12 fl
                <?php if(isset($_GET['id'])&&$_GET['id']==3){echo "cur";} ?>">
                    <a href = '/hardware?id=3'>价格</a></dd>
                <div class="clear"></div>
            </dl>
        </div>
        <div class="w-main m-auto m-t-25 fl">
            ...
            <ul class="w-560 hg-36 ql_pages m-auto">
                ...
                <li class="fl"><a class="" href="hardware?page=1">1</a></li>
                <li class="fl"><a class="" href="hardware?page=1">2</a></li>
                <li class="fl"><a class="" href="hardware?page=3">3</a></li>
                <li class="fl"><a class="" href="hardware?page=4">4</a></li>
                <li class="fl"><a class="" href="hardware?page=5">5</a></li>
                <li class="fl"><a class="" href="#">&gt;</a></li>
