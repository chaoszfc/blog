    ...
    <div class="w-main m-auto"> 
            ...
            <div class="w-1150 ql_ftclass">
                <div class="w-all p-t-16 p-b-16 ovhidden">
                    ...
                    <ul class="w-970 fl">
                        ...
                        <li class="w-70 m-l-24 fl"><a href="/discs" class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl class_cur">硬盘</a></li>
                ...
                <div class="w-all p-t-16 p-b-16 ovhidden">
                    ...
                    <ul class="w-970 fl">
                        ...
                        <li class="w-70 m-l-24 fl"><a href='/discs?company=1' class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                        <?php if(isset($_GET['company'])&&$_GET['company']=='1'){echo "class_cur";}?>
                         ">东芝</a></li>
                        <li class="w-70 m-l-24 fl"><a href='/discs?company=2' class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
        ...
        <div class="w-main m-auto m-t-25 fl">
            <ul class="home_calss w-1224 ovhidden" id="test">
                    ...
                    @foreach($discs as $ddd)
                <li class="w-265 m-l-13 m-r-13 bg-c-ffffff m-t-8 m-b-33 fl">
                    <a href="课程详情.html" class="dsblock w-280 hg-200 ovhidden ps-r">
                        <img src="{{$ddd->hardware_thumb}}" alt=""/> </a>
                    <div class="w-255 p-l-10 p-r-15 p-b-10 fl">
                        <div class="home_calsstxt w-155 fl">
                            <h3 class="w-all fs-16 ftc-000000 line-h32  one_hidden  m-t-6 fl">{{$ddd->hardware_name}}</h3>
                            <span class="dsblock w-all fs-20 ftc-ff0000 line-h32 fl">{{$ddd->product_name}}</span>
                        </div>
