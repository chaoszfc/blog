...
<head lang="en">
<meta charset="UTF-8">
<title>配now-硬件外设-cpu</title>
<meta name="keywords" content="齐峰教育">
<meta name="description" content="齐峰教育">
        ...
        <div class="w-1150 p-l-25 p-r-25 bg-c-ffffff fl">
            ...
            <div class="w-1150 ql_ftclass">
                <div class="w-all p-t-16 p-b-16 ovhidden">
                    ...
                    <ul class="w-970 fl">
                        <li class="w-70 m-l-24 fl"><a href="/cpu" class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl class_cur">CPU</a></li>
                        ...
                        <li class="w-70 m-l-24 fl"><a href="/waishe" class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl ">外设</a></li>
                        <div class="clear"></div>
                    </ul>
                </div>
                ...
                <div class="w-all fl hg-1 bg-c-d2d2d2"></div>
                <div class="w-all p-t-16 p-b-16 ovhidden">
                    <div class="w-80 fs-14 line-h28 m-t-6 m-b-6 ftc-888888 fl">CPU类型</div>
                    <ul class="w-970 fl">
                        ...
                        <li class="w-70 m-l-24 fl"><a href='/cpu?name=1' class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                        <?php if(isset($_GET['name'])&&$_GET['name']=='1'){echo "class_cur";}?>
                         ">Intel</a></li>
                        <li class="w-70 m-l-24 fl"><a href='/cpu?name=2' class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                        <?php if(isset($_GET['name'])&&$_GET['name']==2){echo "class_cur";}?>
                         ">AMD</a></li>
                        <div class="clear"></div>
                    </ul>
                </div>
                ...
                <div class="w-all p-t-16 p-b-16 ovhidden">
                    ...
                    <ul class="w-970 fl">
                        {{--<li class="w-70 m-l-24 fl"><a href="#" class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl class_cur">不限</a></li>--}}
                        <li class="w-70 m-l-24 fl"><a href='<?php echo $_SERVER['REQUEST_URI']?>&price=1'
                                    class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                            <?php if(isset($_GET['price'])&&$_GET['price']==1){echo "class_cur";}?>">0-1999</a></li>
                        <li class="w-70 m-l-24 fl"><a href='<?php echo $_SERVER['REQUEST_URI']?>&price=2'
                                    class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                            <?php if(isset($_GET['price'])&&$_GET['price']==2){echo "class_cur";}?>">2000-3999</a></li>
                        <li class="w-70 m-l-24 fl"><a href='<?php echo $_SERVER['REQUEST_URI']?>&price=3'
                                                      class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                             <?php if(isset($_GET['price'])&&$_GET['price']==3){echo  "class_cur";}?>">4000-5999</a></li>
                        <li class="w-70 m-l-24 fl"><a href='<?php echo $_SERVER['REQUEST_URI']?>&price=4'
                                                      class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                             <?php if(isset($_GET['price'])&&$_GET['price']==4){echo "class_cur";}?> ">6000以上</a></li>
                        <div class="clear"></div>
                    </ul>
                </div>
                ...
                <div class="w-all p-t-16 p-b-16 ovhidden">
                    ...
                    <ul class="w-970 fl">
                        <li class="w-70 m-l-24 fl"><a href='<?php echo $_SERVER['REQUEST_URI']?>&spe=1' class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                             <?php if (isset($_GET['spe'])&&$_GET['spe']==1){echo "class_cur";}?>">价格友好</a></li>
                        <li class="w-70 m-l-24 fl"><a href='<?php echo $_SERVER['REQUEST_URI']?>&spe=2' class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                              <?php if (isset($_GET['spe'])&&$_GET['spe']==2){echo "class_cur";}?>">性价比高</a></li>
                        <li class="w-70 m-l-24 fl"><a href='<?php echo $_SERVER['REQUEST_URI']?>&spe=3' class="dsblock w-all fs-14 line-h28 ftc-888888 m-t-6 m-b-6 curpter text-c fl
                             <?php if(isset($_GET['spe'])&&$_GET['spe']==3){echo "class_cur";}?>">极致性能</a></li>
                        <div class="clear"></div>
                    </ul>
                </div>
        ...
        <div class="w-main m-auto m-t-25 fl">
            <ul class="home_calss w-1224 ovhidden" id="test">
                ...
                <li class="w-265 m-l-13 m-r-13 bg-c-ffffff m-t-8 m-b-33 fl">
                    <a href="" class="dsblock w-280 hg-200 ovhidden ps-r">
                        <img src="{{$pp->hardware_thumb}}" alt=""/> </a>
                    <div class="w-255 p-l-10 p-r-15 p-b-10 fl">
                        <div class="home_calsstxt w-155 fl">
                            <h3 class="w-all fs-16 ftc-000000 line-h32  one_hidden  m-t-6 fl">{{$pp->hardware_name}}</h3>

                            <span class="dsblock w-all fs-20 ftc-ff0000 line-h32 fl">{{$pp->product_name}}</span>

                        </div>
                        <a href="" class="dsblock ql_icon hg-34 line-h34 fs-14 ftc-ffffff m-t-22 ql_h_btnfr w-86 text-c fr">查看详情</a>
                    </div>
                </li>
                @endforeach
                <div class="clear"></div>
