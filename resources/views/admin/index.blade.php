	...
	<div class="menu_box">
		<ul>
			<li>
				...
				<ul class="sub_menu">
					<li><a href = "" target="main"><i class="fa fa-fw"></i>论坛系统</a></li>
					...
					<li><a href = "" target="main"><i class="fa fa-fw"></i>推荐系统</a></li>
					<li><a href="{{url('admin/product/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>硬件类型添加</a></li>
					<li><a href="{{url('admin/product')}}" target="main"><i class="fa fa-fw fa-joomla"></i>硬件类型分类</a></li>
					<li><a href="{{url('admin/hardware/create')}}" target="main"><i class="fa fa-fw fa-plus-square"></i>硬件添加</a></li>
					<li><a href="{{url('admin/hardware')}}" target="main"><i class="fa fa-fw  fa-steam-square"></i>硬件分类</a></li>
				</ul>
			</li>
			<li>
